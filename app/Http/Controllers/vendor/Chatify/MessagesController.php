...
class MessagesController extends Controller
{
    ...
    public function getFavorites(Request $request)
    {
        ...
        return Response::json([
            'favorites' => $favorites->count() > 0
                ? $favoritesList
                : '<p class="message-hint"><span>Votre liste de favoris est vide</span></p>',
        ], 200);
    }
    ...
    public function search(Request $request)
    {
        ...
        return Response::json([
            'records' => $records->count() > 0
                ? $getRecords
                : '<p class="message-hint"><span>Rien à montrer.</span></p>',
            'addData' => 'html'
        ], 200);
    }
    ...
    public function sharedPhotos(Request $request)
    {
        ...
        // send the response
        return Response::json([
            'shared' => count($shared) > 0 ? $sharedPhotos : '<p class="message-hint"><span>Rien de partagé pour le moment</span></p>',
        ], 200);
    }
